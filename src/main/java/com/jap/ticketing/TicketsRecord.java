...
public class TicketsRecord {
    ...
    private double travelling_distance;
    ...
    public double getTravelling_distance() {
        return travelling_distance;
    }

    public void setTravelling_distance(double travelling_distance) {
        this.travelling_distance = travelling_distance;
    }

    public TicketsRecord(String schedule_no, String route_no, int ticket_from_stop_id, int ticket_from_stop_seq_no, int ticket_till_stop_id, int ticket_till_stop_seq_no, String ticket_date, String ticket_time, double total_ticket_amount, double travelling_distance) {
        this.schedule_no = schedule_no;
        this.route_no = route_no;
        this.ticket_from_stop_id = ticket_from_stop_id;
        this.ticket_from_stop_seq_no = ticket_from_stop_seq_no;
    ...
    public String toString() {
        return "TicketsRecord{" +
                ...
                ", travelling_distance=" + travelling_distance +
                '}';
    }
}
